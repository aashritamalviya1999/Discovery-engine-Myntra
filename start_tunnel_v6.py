...
log_path = os.path.join(working_dir, "tunnel_v6.log")

cmd = ["ssh", "-o", "StrictHostKeyChecking=no", "-R", "80:127.0.0.1:8352", "nokey@localhost.run"]

print("Starting clean localhost.run tunnel process...")
    ...
    if os.path.exists(log_path):
        with open(log_path, "r", encoding="utf-8") as f:
            ...
            if match:
                ...
                print(f"🎉 VERIFIED LIVE PUBLIC URL: {url_found}")
                break

if url_found:
    print("Tunnel is active and locked.")
    while True:
        time.sleep(5)
else:
